...
public class JsonParseTool {
    ...
    public static MediaBean parseMediaFormat(String mediaFormat) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(durationStr)) {
                ...
                mediaBean.setDuration(duration.longValue());
            }

            JSONArray jsonMediaStream = jsonMedia.optJSONArray("streams");
            ...
            for (int index = 0; index < jsonMediaStream.length(); index++) {
                ...
                if (codecType.equals(TYPE_VIDEO)) {
                    ...
                    JSONObject audioTag = jsonMediaFormat.optJSONObject("tags");
                    if (audioTag != null) {
    ...
    private static void parseTag(JSONObject audioTag, AudioBean audioBean) {
        ...
        if (lyrics != null && lyrics.contains("\r\n")) {
            ...
            audioBean.setLyrics(List.of(array));
        }
    }
}